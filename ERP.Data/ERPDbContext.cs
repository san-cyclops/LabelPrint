...
namespace ERP.Data
{
    public class ERPDbContext: DbContext
    {
        ...
        //Restaurant
        public DbSet<InvProductType> InvProductTypes { get; set; }
        public DbSet<InvPriceLevel> InvPriceLevels { get; set; }
        public DbSet<InvPriceLevelList> InvPriceLevelLists { get; set; }
        public DbSet<InvProductAssemble> InvProductAssembles { get; set; }
        ...
        public DbSet<SlabReference> SlabReferences { get; set; }
        public DbSet<JobClass> JobsClasses { get; set; }
        ...
        public DbSet<CreditCardBankMaster> CreditCardBankMasters { get; set; }
        ...
        #region Inventory
        //Reference
        public DbSet<InvAgeAnalysisSlab> InvAgeAnalysisSlabs { get; set; }
        public DbSet<InvAgeAnalysisSlabReportTable> InvAgeAnalysisSlabReports { get; set; }
        ...
        //public DbSet<PriceLevels> PriceLevelsx { get; set; }
        ...
        public DbSet<TempInvProductBatchNoExpiaryDetail> TempInvProductStockMasters { get; set; }
        ...
        public DbSet<InvKitchenBar> InvKitchensBars { get; set; }
        ...
        public DbSet<InvProductMenu> InvProductMenus { get; set; }
        ...
        //Barcode
        public DbSet<InvBarcode> InvBarcodes { get; set; }
        public DbSet<InvBarCodeConfig> InvBarCodeConfigs { get; set; }
        ...
        public DbSet<TempTransactionDet> TempTransactionDets { get; set; }
        public DbSet<TempPaymentDet> TempPaymentDets { get; set; }

        //Sample In & Out
        public DbSet<InvSampleOutHeader> InvSampleOutHeaders { get; set; }
        public DbSet<InvSampleOutDetail> InvSampleOutDetails { get; set; }



        public DbSet<InvSampleInHeader> InvSampleInHeaders { get; set; }
        public DbSet<InvSampleInDetail> InvSampleInDetails { get; set; }
        public DbSet<InvTempGrossProfit> InvTempGrossProfit { get; set; }

        public DbSet<TempPosSale> TempPosSale { get; set; }

        public DbSet<TempPosCreditCards> TempPosCreditCards { get; set; }

        public DbSet<TempSupplierWiseReorderLevelProduct> TempSupplierWiseReorderLevelProduct { get; set; }

        public DbSet<TempCustomerCreditSettlements> TempCustomerCreditSettlements { get; set; }

        public DbSet<DTSConfig> DTSConfigs { get; set; }
        ...
        public DbSet<CardGenerationLocationSetting> CardGenerationLocationSettings { get; set; }
        ...
        public DbSet<TempLoyaltyPoint> TempLoyaltyPoints { get; set; }

        public DbSet<TempLoyaltyTransactionSummery> TempLoyaltyTransactionSummerys { get; set; }

        public DbSet<PurchaseBreakdown> PurchaseBreakowns { get; set; }
        public DbSet<TempPurchaseBreakdown> TempPurchaseBreakdowns { get; set; }
        public DbSet<TempLoyaltyPurchase> TempLoyaltyPurchases { get; set; }

        public DbSet<CrmReportCondition> CrmReportConditions { get; set; }
        ...
        //Sample In & Out
        public DbSet<LgsSampleOutHeader> LgsSampleOutHeaders { get; set; }
        public DbSet<LgsSampleOutDetail> LgsSampleOutDetails { get; set; }


        public DbSet<LgsSampleInHeader> LgsSampleInHeaders { get; set; }
        public DbSet<LgsSampleInDetail> LgsSampleInDetails { get; set; }
        #endregion
        #endregion
        ...
        public DbSet<TempPosPaymentDet> TempPosPaymentDets { get; set; }
        public DbSet<TempPosTransactionDet> TempPosTransactionDets { get; set; }
        ...
        public DbSet<SupplierWiseStockMovement> SupplierWiseStockMovements { get; set; }
        public DbSet<HourlySales> HourlySales { get; set; }
        public DbSet<TempDailySalesSummary> TempDailySalesSummary { get; set; }

        #endregion

        #region DashBoard

        public DbSet<TransactionDetPromotion> TransactionDetPromotions { get; set; }
        public DbSet<TempPromotionSale> TempPromotionSales { get; set; }
        ...
        public DbSet<ChangedTableItemDet> ChangedTableItemDets { get; set; }
        public DbSet<ChangedTablePaymentDet> ChangedTablePaymentDets { get; set; }
        public DbSet<Counter> Counters { get; set; }
        public DbSet<DayStart> DayStarts { get; set; }
        public DbSet<ShiftDet> ShiftDets { get; set; }
        public DbSet<RestaurentReportCondition> RestaurentReportConditions { get; set; }
        public DbSet<BillingLocation> BillingLocations { get; set; }
        public DbSet<Shift> Shifts { get; set; }
        public DbSet<Unit> Units { get; set; }
        public DbSet<PaidInType> PaidInTypes { get; set; }
        public DbSet<PaidOutType> PaidOutTypes { get; set; }
        public DbSet<InvoiceWiseSalesTemp> InvoiceWiseSalesTemps { get; set; }
        public DbSet<OrderTerminal> OrderTerminals { get; set; }
        public DbSet<TableDetail> TableDetails { get; set; }
        public DbSet<BillingLocationAssignedCostCentre> BillingLocationAssignedCostCentres { get; set; }
        public DbSet<InvProductMasterBillingLocationWise> InvProductMasterBillingLocationsWise { get; set; }
        public DbSet<InvSubCategoryBillingLocationWise> InvSubCategoryBillingLocationsWise { get; set; }
        public DbSet<InvSubCategory2BillingLocationWise> InvSubCategory2BillingLocationsWise { get; set; }

        #endregion

        #region General Ledger

        public DbSet<AccTransactionDefinition> AccTransactionDefinitions { get; set; }

        // General Ledger
        #region Reference

        public DbSet<AccLedgerAccount> AccLedgerAccounts { get; set; }
        //public DbSet<AccSalesDownloadSetting> AccSalesDownloadSettings { get; set; }


        #endregion

        #region Transaction
        public DbSet<AccChequeNoEntry> AccChequeNoEntries { get; set; }
        ...
        public DbSet<AccGlTransactionDetailTemp> AccGlTransactionDetailTemps { get; set; }
        public DbSet<AccTransactionTemplateHeader> AccTransactionTemplateHeaders { get; set; }
        public DbSet<AccTransactionTemplateDetail> AccTransactionTemplateDetails { get; set; }
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
           ...
           // Database.SetInitializer(new ERPDbContextInitializer());
            ...
            modelBuilder.Properties<decimal>()
                .Configure(x => x.HasPrecision(18, global::ERP.Utility.Common.decimalPointsCurrency));

            modelBuilder.Properties<decimal>()
                .Where(prop => prop.Name.Contains("Qty"))
                //.Configure(config => config.IsKey());
                .Configure(x => x.HasPrecision(18, global::ERP.Utility.Common.decimalPointsQty));
