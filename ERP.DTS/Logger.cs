...
namespace ERP.DTS
{
    public static class Logger
    {
        ...
        */
        ...
        public static string debugFilePath = System.Configuration.ConfigurationManager.AppSettings["logpath"];
        ...
        public static void WriteLog(Exception log, string methodName, string formName = "Default", logtype LogType = logtype.ErrorLog, long LocationID = 1)
        {
            ...
            try
            {
                ...
                bool isExistsxx = System.IO.Directory.Exists(debugFilePath);
                if (!isExistsxx)
                    System.IO.Directory.CreateDirectory(debugFilePath);
                ...
                switch (LogType)
                {
                    case logtype.ErrorLog:
                        tmpdebugFilePath = debugFilePath + @"\Errors";
                        bool isExistss = System.IO.Directory.Exists(tmpdebugFilePath);
                        if (!isExistss)
                            System.IO.Directory.CreateDirectory(tmpdebugFilePath);
                        tmpdebugFilePath = debugFilePath + @"\Errors\Error-" + DateTime.Now.ToString("dd-MM-yyyy") + ".log";
                        System.IO.File.AppendAllText(tmpdebugFilePath, "Date Time : [" + System.DateTime.Now.ToString("dd-MM-yyyy HH:mm:ss") + "] " + "| Error : " + log.Message.ToString().Trim() + "\r\n");
                        break;
                    case logtype.Event:
                        ...
                        System.IO.File.AppendAllText(@tmpdebugFilePath, "Date Time : [" + System.DateTime.Now.ToString("dd-MM-yyyy HH:mm:ss") + "] " + "| Event : " + log.Message.ToString().Trim() + "\r\n");
                        break;
                    default:
        ...
        public static void WriteLog(string log, string methodName,string formName="Default", logtype LogType = logtype.ErrorLog, long LocationID = 1)
        {
            ...
            try
            {
                ...
                switch (LogType)
                {
                    case logtype.ErrorLog:
                        tmpdebugFilePath = debugFilePath + "Error.log";
                            System.IO.File.AppendAllText(tmpdebugFilePath, "Date Time : [" + System.DateTime.Now.ToString("dd-MM-yyyy HH:mm:ss") + "] " +  "| Error : " + log.Trim() + "\r\n");
