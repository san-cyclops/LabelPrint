...
namespace ERP.Report.GUI
{
    public partial class FrmExtendedPropertyReports : FrmBaseReportsForm
    {
        ...
        private DataSet GetReportData()
        {
            ...
            {
                Toast.Show(this.Text, "Product Extended Property","", Toast.messageType.Warning, Toast.messageAction.NotExists);
                return null;
            }
            ...
            {
                Toast.Show(this.Text, "Product Property Values","", Toast.messageType.Warning, Toast.messageAction.NotExists);
                return null;
            }
            ...
            {
                Toast.Show(this.Text, "Product Property Type ","", Toast.messageType.Warning, Toast.messageAction.NotExists);
                return null;
            }
            ...
            {
                Toast.Show(this.Text, "Locations ","", Toast.messageType.Warning, Toast.messageAction.NotExists);
                return null;
            }
        ...
        private string GetProductPropertyType()
        {
            ...
            {
                Toast.Show(this.Text, "Product Property ","", Toast.messageType.Warning, Toast.messageAction.NotExists);
                return null;
            }
            else
            {
        ...
        private void grpProductExtendedProperties_Enter(object sender, EventArgs e)
        {

        }

        private void rbtnDepartment_Enter(object sender, EventArgs e)
        {
            Common.HighlightControl(rbtnDepartment);
        }

        private void rbtnDepartment_Leave(object sender, EventArgs e)
        {
            Common.UnHighlightControl(rbtnDepartment);
        }

        private void rbtnCategory_Enter(object sender, EventArgs e)
        {
            Common.HighlightControl(rbtnCategory);
        }

        private void rbtnCategory_Leave(object sender, EventArgs e)
        {
            Common.UnHighlightControl(rbtnCategory);
        }

        private void rbtnSubCategory_Enter(object sender, EventArgs e)
        {
            Common.HighlightControl(rbtnSubCategory);
        }

        private void rbtnSubCategory_Leave(object sender, EventArgs e)
        {
            Common.UnHighlightControl(rbtnSubCategory);
        }

        private void rbtnSubCategory2_Enter(object sender, EventArgs e)
        {
            Common.HighlightControl(rbtnSubCategory2);
        }

        private void rbtnSubCategory2_Leave(object sender, EventArgs e)
        {
            Common.UnHighlightControl(rbtnSubCategory2);
        }
