...
namespace ERP.Report.GUI
{
    public partial class FrmReportGenerator2 : FrmBaseReportsForm
    {
        ...
        Color defaultColor = Color.PowderBlue;
        ...
        private DataTable GetSupplier()
        {
            ...
            // if (rbtnSupplier.Checked)
            {
                if (rbtnReportTypeSelection.Checked)
                {
                    ...
                    //var selected = chkLstReportType.Items.Cast<ListViewItem>().Where(x => x.Selected);
                    ...
                    for (int i = 0; i < chkLstReportType.Items.Count; i++)
                    {
                        ...
                        {
                            string str = (string)chkLstReportType.Items[i];
        ...
        public override void View()
        {
            try
            {
                ...
                if (rbtnLocationSelection.Checked)
                {
                    if (!locationList.Any(l => l.isChecked.Equals(CheckState.Checked)))
                    {
                        Toast.Show(this.Text, "Locations ", "", Toast.messageType.Information, Toast.messageAction.Empty);
                        return;
                    }
                }
                ...
                if (rbtnLocationRange.Checked)
                {
                    ...
                    {
                        Toast.Show(this.Text, "Invalid Location range.\nLocation range does not in ascending order.", "", Toast.messageType.Information, Toast.messageAction.General);
                        return;
                    }
                }
                ...
                if (reportService.ExecuteReportStoredProcedure(productCodeFrom, productCodeTo, report, reportType, false, false, dtLocations, dtDepartments, dtCategories,
                    dtSubCategories, dtSubCategories2, dtSupplier, dtProductExtendedProperties, displayType, dateFrom, dateTo))
                {
                    ViewReport(dtLocations, dtProductExtendedProperties, report, false, false, false, false, dateFrom, dateTo);
                }
                else
                {
                    Toast.Show(this.Text, "Invalid data processing", "", Toast.messageType.Information, Toast.messageAction.General);
                    return;
                }
            }
            catch (Exception ex)
        ...
        private void ViewReport(DataTable dtLocations, DataTable dtExtendedProperty, string report, bool isAmt, bool isQty, bool isCval, bool isSval, DateTime dateFrom, DateTime dateTo)
        {
            ...
            {
                InvRptSupplierWiseReport_Manjari invRptSupplierWiseQty = new InvRptSupplierWiseReport_Manjari();
                ...
                #region Supplier
                {
...

                    {
                        ...
                        invRptSupplierWiseQty.SummaryInfo.ReportTitle = "Supplier Wise Consignment";
                ...
                if (chkSubCategory.Checked.Equals(true))
                {
                    ...
                    {
                        InvRptSupplierWiseReport invRptSupplierWiseReport = new InvRptSupplierWiseReport();

                        invRptSupplierWiseReport.SetDataSource(dtReportData);
                        invRptSupplierWiseReport.SummaryInfo.ReportTitle = "Supplier Wise Consignment";
                        invRptSupplierWiseReport.SummaryInfo.ReportAuthor = Common.AuthorName + "  " + Common.AuthorAddress;
                        invRptSupplierWiseReport.DataDefinition.FormulaFields["LogingUser"].Text = "'" + Common.LoggedUser + "'";
                        invRptSupplierWiseReport.DataDefinition.FormulaFields["LogingLocation"].Text = "'" + Common.LoggedLocationName + "'";
                        invRptSupplierWiseReport.DataDefinition.FormulaFields["CompanyName"].Text = "'" + Common.LoggedCompanyName + "'";
                        invRptSupplierWiseReport.DataDefinition.FormulaFields["Address"].Text = "'" + Common.LoggedCompanyAddress + "'";
                        invRptSupplierWiseReport.DataDefinition.FormulaFields["FromDate"].Text = "'" + dateFrom.ToShortDateString() + "'";
                        invRptSupplierWiseReport.DataDefinition.FormulaFields["ToDate"].Text = "'" + dateTo.ToShortDateString() + "'";
                        invRptSupplierWiseReport.DataDefinition.FormulaFields["FromRange"].Text = "''";
                        invRptSupplierWiseReport.DataDefinition.FormulaFields["ToRange"].Text = "''";

                        reportViewer.crRptViewer.ReportSource = invRptSupplierWiseReport;
                    }
                    else // SubCat only
                    {

                        {
                            InvRptSupplierWiseReport invRptSubCategoryWiseQty = new InvRptSupplierWiseReport();
                            invRptSubCategoryWiseQty.SetDataSource(dtReportData);
                            invRptSubCategoryWiseQty.SummaryInfo.ReportTitle = "Supplier Wise Consignment";
                ...
                {
                    InvRptSupplierWiseReport invRptSubCategory2WiseQty = new InvRptSupplierWiseReport();
                    invRptSubCategory2WiseQty.SetDataSource(dtReportData);
                    invRptSubCategory2WiseQty.SummaryInfo.ReportTitle = "Supplier Wise Consignment";
            ...
            else
            {
                ...
                InvRptSupplierWiseReport invRptSupplierWiseQty = new InvRptSupplierWiseReport();
                ...
                if (chkDepartment.Checked.Equals(true))
                {
                    ...
                    {
                        {
                            InvRptSupplierWiseReport invRptDepartmentWiseCategoryWiseAmount = new InvRptSupplierWiseReport();
                            invRptDepartmentWiseCategoryWiseAmount.SetDataSource(dtReportData);
                            invRptDepartmentWiseCategoryWiseAmount.SummaryInfo.ReportTitle = "Supplier Wise Consignment";
                    ...
                    else if (chkSubCategory.Checked.Equals(true)) // Dept and SubCat
                    {
                        ...
                        InvRptSupplierWiseReport invRptDepartmentWiseSubCategoryWiseQty = new InvRptSupplierWiseReport();
                        invRptDepartmentWiseSubCategoryWiseQty.SetDataSource(dtReportData);
                        invRptDepartmentWiseSubCategoryWiseQty.SummaryInfo.ReportTitle = "Supplier Wise Consignment";
                    ...
                    {
                        InvRptSupplierWiseReport invRptDepartmentWiseSubCategory2WiseAmount = new InvRptSupplierWiseReport();
                        invRptDepartmentWiseSubCategory2WiseAmount.SetDataSource(dtReportData);
                        invRptDepartmentWiseSubCategory2WiseAmount.SummaryInfo.ReportTitle = "Supplier Wise Consignment";
                    ...
                    {
                        InvRptSupplierWiseReport invRptDepartmentWiseQty = new InvRptSupplierWiseReport();
                        invRptDepartmentWiseQty.SetDataSource(dtReportData);
                        invRptDepartmentWiseQty.SummaryInfo.ReportTitle = "Supplier Wise Consignment";
                ...
                if (chkCategory.Checked.Equals(true))
                {
                    ...
                    if (chkSubCategory.Checked.Equals(true)) // Cat and SubCat
                    {
                        InvRptSupplierWiseReport invRptCategoryWiseSubCategoryWiseQty = new InvRptSupplierWiseReport();
                        invRptCategoryWiseSubCategoryWiseQty.SetDataSource(dtReportData);
                        invRptCategoryWiseSubCategoryWiseQty.SummaryInfo.ReportTitle = "Supplier Wise Consignment";
                    ...
                    {
                        InvRptSupplierWiseReport invRptCategoryWiseSubCategory2WiseQty = new InvRptSupplierWiseReport();
                        invRptCategoryWiseSubCategory2WiseQty.SetDataSource(dtReportData);
                        invRptCategoryWiseSubCategory2WiseQty.SummaryInfo.ReportTitle = "Supplier Wise Consignment";
                    ...
                    {
                        InvRptSupplierWiseReport invRptCategoryWiseQty = new InvRptSupplierWiseReport();
                        invRptCategoryWiseQty.SetDataSource(dtReportData);
                        invRptCategoryWiseQty.SummaryInfo.ReportTitle = "Supplier Wise Consignment";
        ...
        private void txtProductCodeFrom_Leave(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    Toast.Show(this.Text, "Product from ", "", Toast.messageType.Information, Toast.messageAction.NotExists);
        ...
        private void txtProductCodeTo_Leave(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    Toast.Show(this.Text, "Product to ", "", Toast.messageType.Information, Toast.messageAction.NotExists);
        ...
        private void txtLocationFrom_KeyDown(object sender, KeyEventArgs e)
        {
            try
            {
                ...
                {
                    Toast.Show(this.Text, "Location from ", "", Toast.messageType.Information, Toast.messageAction.NotExists);
                    return;
                }
            }
            catch (Exception ex)
        ...
        private void txtLocationFrom_Leave(object sender, EventArgs e)
        {
            try
            {
                Common.UnHighlightControl(lblLocationFrom);
                if (string.IsNullOrEmpty(txtLocationFrom.Text.Trim()))
                { return; }
        ...
        private void txtLocationTo_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                Toast.Show(this.Text, "Location to ", "", Toast.messageType.Information, Toast.messageAction.NotExists);
                return;
            }
        }
        ...
        {
            Common.UnHighlightControl(lblLocationTo);
            if (string.IsNullOrEmpty(txtLocationTo.Text.Trim()))
            { return; }
        ...
        private void txtDepartmentFrom_KeyDown(object sender, KeyEventArgs e)
        {
            try
            {
                ...
                {
                    Toast.Show(this.Text, "Department from ", "", Toast.messageType.Information, Toast.messageAction.NotExists);
                    return;
                }
            }
            catch (Exception ex)
        ...
        private void txtDepartmentFrom_Leave(object sender, EventArgs e)
        {
            try
            {
                Common.UnHighlightControl(lblDepartmentFrom);
                if (string.IsNullOrEmpty(txtDepartmentFrom.Text.Trim()))
                { return; }
        ...
        private void txtDepartmentTo_KeyDown(object sender, KeyEventArgs e)
        {
            try
            {
                ...
                {
                    Toast.Show(this.Text, "Department to ", "", Toast.messageType.Information, Toast.messageAction.NotExists);
                    return;
                }
            }
            catch (Exception ex)
        ...
        private void txtDepartmentTo_Leave(object sender, EventArgs e)
        {
            try
            {
                Common.UnHighlightControl(lblDepartmentTo);
                if (string.IsNullOrEmpty(txtDepartmentTo.Text.Trim()))
                { return; }
        ...
        private void txtCategoryFrom_KeyDown(object sender, KeyEventArgs e)
        {
            try
            {
                ...
                {
                    Toast.Show(this.Text, "Category to ", "", Toast.messageType.Information, Toast.messageAction.NotExists);
                    return;
                }
            }
            catch (Exception ex)
        ...
        private void txtCategoryFrom_Leave(object sender, EventArgs e)
        {
            try
            {
                Common.UnHighlightControl(lblCategoryFrom);
                if (string.IsNullOrEmpty(txtCategoryFrom.Text.Trim()))
                { return; }
                ...
                {
                    Toast.Show(this.Text, "Category from ", "", Toast.messageType.Information, Toast.messageAction.NotExists);
                    return;
                }
            }
            catch (Exception ex)
        ...
        private void txtCategoryTo_Leave(object sender, EventArgs e)
        {
            try
            {
                Common.UnHighlightControl(lblCategoryTo);
                if (string.IsNullOrEmpty(txtCategoryTo.Text.Trim()))
                { return; }
        ...
        private void txtSubCategoryFrom_KeyDown(object sender, KeyEventArgs e)
        {
            try
            {
                ...
                {
                    Toast.Show(this.Text, "Sub Category from ", "", Toast.messageType.Information, Toast.messageAction.NotExists);
                    return;
                }
            }
            catch (Exception ex)
        ...
        private void txtSubCategoryFrom_Leave(object sender, EventArgs e)
        {
            try
            {
                Common.UnHighlightControl(lblSubCategoryFrom);
                if (string.IsNullOrEmpty(txtSubCategoryFrom.Text.Trim()))
                { return; }
        ...
        private void txtSubCategoryTo_KeyDown(object sender, KeyEventArgs e)
        {
            try
            {
                ...
                {
                    Toast.Show(this.Text, "Sub Category to ", "", Toast.messageType.Information, Toast.messageAction.NotExists);
                    return;
                }
            }
            catch (Exception ex)
        ...
        private void txtSubCategory2From_KeyDown(object sender, KeyEventArgs e)
        {
            try
            {
                ...
                {
                    Toast.Show(this.Text, "Sub Category 2 from ", "", Toast.messageType.Information, Toast.messageAction.NotExists);
                    return;
                }
            }
            catch (Exception ex)
        ...
        private void txtSubCategory2From_Leave(object sender, EventArgs e)
        {
            try
            {
                Common.UnHighlightControl(lblSubCategory2From);
                if (string.IsNullOrEmpty(txtSubCategory2From.Text.Trim()))
                { return; }
        ...
        private void txtSubCategory2To_KeyDown(object sender, KeyEventArgs e)
        {
            try
            {
                ...
                {
                    Toast.Show(this.Text, "Sub Category 2 to ", "", Toast.messageType.Information, Toast.messageAction.NotExists);
                    return;
                }
            }
            catch (Exception ex)
        ...
        private void CheckedAllLocation()
        {
        ...
        private void txtSubCategory2To_Leave(object sender, EventArgs e)
        {
            try
            {
                Common.UnHighlightControl(lblSubCategory2To);
                if (string.IsNullOrEmpty(txtSubCategory2To.Text.Trim()))
                { return; }
        ...
        private void txtReportTypeFrom_KeyDown(object sender, KeyEventArgs e)
        {
            try
            {
                ...
                if (rbtnSupplier.Checked)
                {
                    ...
                    {
                        Toast.Show(this.Text, "Supplier from ", "", Toast.messageType.Information, Toast.messageAction.NotExists);
                        return;
                    }
                }
                if (rbtnCustomer.Checked)
                {
                    ...
                    {
                        Toast.Show(this.Text, "Customer from ", "", Toast.messageType.Information, Toast.messageAction.NotExists);
                        return;
                    }
                }
            }
        ...
        private void txtReportTypeFrom_Leave(object sender, EventArgs e)
        {
            try
            {
                Common.UnHighlightControl(lblSelectFrom);
                if (string.IsNullOrEmpty(txtReportTypeFrom.Text.Trim()))
                { return; }
        ...
        private void txtReportTypeTo_KeyDown(object sender, KeyEventArgs e)
        {
            try
            {
                ...
                if (rbtnSupplier.Checked)
                {
                    ...
                    {
                        Toast.Show(this.Text, "Supplier to ", "", Toast.messageType.Information, Toast.messageAction.NotExists);
                        return;
                    }
                }
                if (rbtnCustomer.Checked)
                {
                    ...
                    {
                        Toast.Show(this.Text, "Customer to ", "", Toast.messageType.Information, Toast.messageAction.NotExists);
                        return;
                    }
                }
            }
        ...
        private void txtReportTypeTo_Leave(object sender, EventArgs e)
        {
            try
            {
                Common.UnHighlightControl(lblSelectTo);
                if (string.IsNullOrEmpty(txtReportTypeTo.Text.Trim()))
                { return; }
        ...
        private void chkAutoComplteProductFrom_Enter(object sender, EventArgs e)
        {
            Common.HighlightControl(lblProductFrom);
        }

        private void chkAutoComplteProductFrom_Leave(object sender, EventArgs e)
        {
            Common.UnHighlightControl(lblProductFrom);
        }

        private void txtProductCodeFrom_Enter(object sender, EventArgs e)
        {
            Common.HighlightControl(lblProductFrom);
        }

        private void txtProductNameFrom_Enter(object sender, EventArgs e)
        {
            Common.HighlightControl(lblProductFrom);
        }

        private void chkAutoComplteProductTo_Enter(object sender, EventArgs e)
        {
            Common.HighlightControl(lblProductTo);
        }

        private void chkAutoComplteProductTo_Leave(object sender, EventArgs e)
        {
            Common.UnHighlightControl(lblProductTo);
        }

        private void txtProductCodeTo_Enter(object sender, EventArgs e)
        {
            Common.HighlightControl(lblProductTo);
        }

        private void txtProductNameTo_Enter(object sender, EventArgs e)
        {
            Common.HighlightControl(lblProductTo);
        }

        private void dtpDateFrom_Enter(object sender, EventArgs e)
        {
            Common.HighlightControl(lblDateFrom);
        }

        private void dtpDateFrom_Leave(object sender, EventArgs e)
        {
            Common.UnHighlightControl(lblDateFrom);
        }

        private void dtpDateTo_Enter(object sender, EventArgs e)
        {
            Common.HighlightControl(lblDateTo);
        }

        private void dtpDateTo_Leave(object sender, EventArgs e)
        {
            Common.UnHighlightControl(lblDateTo);
        }

        private void rbtnLocationSelection_Enter(object sender, EventArgs e)
        {
            Common.HighlightControl(rbtnLocationSelection);
        }

        private void rbtnDepartmentSelection_Enter(object sender, EventArgs e)
        {
            Common.HighlightControl(rbtnDepartmentSelection);
        }

        private void rbtnDepartmentSelection_Leave(object sender, EventArgs e)
        {
            Common.UnHighlightControl(rbtnDepartmentSelection);
        }

        private void rbtnCategorySelection_Enter(object sender, EventArgs e)
        {
            Common.HighlightControl(rbtnCategorySelection);
        }

        private void rbtnCategorySelection_Leave(object sender, EventArgs e)
        {
            Common.UnHighlightControl(rbtnCategorySelection);
        }

        private void rbtnSubCategorySelection_Enter(object sender, EventArgs e)
        {
            Common.HighlightControl(rbtnSubCategorySelection);
        }

        private void rbtnSubCategorySelection_Leave(object sender, EventArgs e)
        {
            Common.UnHighlightControl(rbtnSubCategorySelection);
        }

        private void rbtnSubCategory2Selection_Enter(object sender, EventArgs e)
        {
            Common.HighlightControl(rbtnSubCategory2Selection);
        }

        private void rbtnSubCategory2Selection_Leave(object sender, EventArgs e)
        {
            Common.UnHighlightControl(rbtnSubCategory2Selection);
        }

        private void rbtnReportTypeSelection_Enter(object sender, EventArgs e)
        {
            Common.HighlightControl(rbtnReportTypeSelection);
        }

        private void rbtnReportTypeSelection_Leave(object sender, EventArgs e)
        {
            Common.UnHighlightControl(rbtnReportTypeSelection);
        }

        private void rbtnLocationRange_Enter(object sender, EventArgs e)
        {
            Common.HighlightControl(rbtnLocationRange);
        }

        private void rbtnLocationRange_Leave(object sender, EventArgs e)
        {
            Common.UnHighlightControl(rbtnLocationRange);
        }

        private void rbtnDepartmentRange_Enter(object sender, EventArgs e)
        {
            Common.HighlightControl(rbtnDepartmentRange);
        }

        private void rbtnDepartmentRange_Leave(object sender, EventArgs e)
        {
            Common.UnHighlightControl(rbtnDepartmentRange);
        }

        private void rbtnCategoryRange_Enter(object sender, EventArgs e)
        {
            Common.HighlightControl(rbtnCategoryRange);
        }

        private void rbtnCategoryRange_Leave(object sender, EventArgs e)
        {
            Common.UnHighlightControl(rbtnCategoryRange);
        }

        private void rbtnSubCategoryRange_Enter(object sender, EventArgs e)
        {
            Common.HighlightControl(rbtnSubCategoryRange);
        }

        private void rbtnSubCategoryRange_Leave(object sender, EventArgs e)
        {
            Common.UnHighlightControl(rbtnSubCategoryRange);
        }

        private void rbtnSubCategory2Range_Enter(object sender, EventArgs e)
        {
            Common.HighlightControl(rbtnSubCategory2Range);
        }

        private void rbtnSubCategory2Range_Leave(object sender, EventArgs e)
        {
            Common.UnHighlightControl(rbtnSubCategory2Range);
        }

        private void rbtnReportTypeRange_Enter(object sender, EventArgs e)
        {
            Common.HighlightControl(rbtnReportTypeRange);
        }

        private void rbtnReportTypeRange_Leave(object sender, EventArgs e)
        {
            Common.UnHighlightControl(rbtnReportTypeRange);
        }

        private void chkAutoComplteLocationFrom_Enter(object sender, EventArgs e)
        {
            Common.HighlightControl(lblLocationFrom);
        }

        private void chkAutoComplteLocationFrom_Leave(object sender, EventArgs e)
        {
            Common.UnHighlightControl(lblLocationFrom);
        }

        private void txtLocationFrom_Enter(object sender, EventArgs e)
        {
            Common.HighlightControl(lblLocationFrom);
        }

        private void chkAutoComplteLocationTo_Enter(object sender, EventArgs e)
        {
            Common.HighlightControl(lblLocationTo);
        }

        private void chkAutoComplteLocationTo_Leave(object sender, EventArgs e)
        {
            Common.UnHighlightControl(lblLocationTo);
        }

        private void txtLocationTo_Enter(object sender, EventArgs e)
        {
            Common.HighlightControl(lblLocationTo);
        }

        private void chkAutoComplteDepartmentFrom_Enter(object sender, EventArgs e)
        {
            Common.HighlightControl(lblDepartmentFrom);
        }

        private void chkAutoComplteDepartmentFrom_Leave(object sender, EventArgs e)
        {
            Common.UnHighlightControl(lblDepartmentFrom);
        }

        private void txtDepartmentFrom_Enter(object sender, EventArgs e)
        {
            Common.HighlightControl(lblDepartmentFrom);
        }

        private void chkAutoComplteDepartmentTo_Enter(object sender, EventArgs e)
        {
            Common.HighlightControl(lblDepartmentTo);
        }

        private void chkAutoComplteDepartmentTo_Leave(object sender, EventArgs e)
        {
            Common.UnHighlightControl(lblDepartmentTo);
        }

        private void txtDepartmentTo_Enter(object sender, EventArgs e)
        {
            Common.HighlightControl(lblDepartmentTo);
        }

        private void chkAutoComplteCategoryFrom_Enter(object sender, EventArgs e)
        {
            Common.HighlightControl(lblCategoryFrom);
        }

        private void chkAutoComplteCategoryFrom_Leave(object sender, EventArgs e)
        {
            Common.UnHighlightControl(lblCategoryFrom);
        }

        private void txtCategoryFrom_Enter(object sender, EventArgs e)
        {
            Common.HighlightControl(lblCategoryFrom);
        }

        private void chkAutoComplteSubCategoryFrom_Enter(object sender, EventArgs e)
        {
            Common.HighlightControl(lblSubCategoryFrom);
        }

        private void chkAutoComplteSubCategoryFrom_Leave(object sender, EventArgs e)
        {
            Common.UnHighlightControl(lblSubCategoryFrom);
        }

        private void txtSubCategoryFrom_Enter(object sender, EventArgs e)
        {
            Common.HighlightControl(lblSubCategoryFrom);
        }

        private void chkAutoComplteSubCategoryTo_Enter(object sender, EventArgs e)
        {
            Common.HighlightControl(lblSubCategoryTo);
        }

        private void chkAutoComplteSubCategoryTo_Leave(object sender, EventArgs e)
        {
            Common.UnHighlightControl(lblSubCategoryTo);
        }

        private void chkAutoComplteSubCategory2From_Enter(object sender, EventArgs e)
        {
            Common.HighlightControl(lblSubCategory2From);
        }

        private void chkAutoComplteSubCategory2From_Leave(object sender, EventArgs e)
        {
            Common.UnHighlightControl(lblSubCategory2From);
        }

        private void txtSubCategory2From_Enter(object sender, EventArgs e)
        {
            Common.HighlightControl(lblSubCategory2From);
        }

        private void chkAutoComplteSubCategory2To_Enter(object sender, EventArgs e)
        {
            Common.HighlightControl(lblSubCategory2To);
        }

        private void chkAutoComplteSubCategory2To_Leave(object sender, EventArgs e)
        {
            Common.UnHighlightControl(lblSubCategory2To);
        }

        private void txtSubCategory2To_Enter(object sender, EventArgs e)
        {
            Common.HighlightControl(lblSubCategory2To);
        }

        private void chkAutoComplteReportTypeFrom_Enter(object sender, EventArgs e)
        {
            Common.HighlightControl(lblSelectFrom);
        }

        private void chkAutoComplteReportTypeFrom_Leave(object sender, EventArgs e)
        {
            Common.UnHighlightControl(lblSelectFrom);
        }

        private void txtReportTypeFrom_Enter(object sender, EventArgs e)
        {
            Common.HighlightControl(lblSelectFrom);
        }

        private void chkAutoComplteReportTypeTo_Enter(object sender, EventArgs e)
        {
            Common.HighlightControl(lblSelectTo);
        }

        private void chkAutoComplteReportTypeTo_Leave(object sender, EventArgs e)
        {
            Common.UnHighlightControl(lblSelectTo);
        }

        private void txtReportTypeTo_Enter(object sender, EventArgs e)
        {
            Common.HighlightControl(lblSelectTo);
        }

        private void chkAutoComplteCategoryTo_Enter(object sender, EventArgs e)
        {
            Common.HighlightControl(lblCategoryTo);
        }

        private void chkAutoComplteCategoryTo_Leave(object sender, EventArgs e)
        {
            Common.UnHighlightControl(lblCategoryTo);
        }

        private void txtCategoryTo_Enter(object sender, EventArgs e)
        {
            Common.HighlightControl(lblCategoryTo);
        }

        private void FrmReportGenerator2_Load(object sender, EventArgs e)
        {
            this.Text = "Supplier Wise Performance Analysis";
        ...
        private void chkAllLocation_CheckedChanged(object sender, EventArgs e)
        {
            try
            {
                if (chkAllLocation.Checked) { CheckedAllLocation(); } else { UnCheckedAllLocations(); }
            }
            catch (Exception ex)
            {
                Logger.WriteLog(ex, MethodInfo.GetCurrentMethod().Name.ToString(), this.Name, Logger.logtype.ErrorLog, Common.LoggedLocationID);
        ...
        private void UnCheckedAllSupplies()
        {
            for (int i = 0; i < chkLstReportType.Items.Count; i++)
            {
                chkLstReportType.SetItemChecked(i, false);
            }
        }
