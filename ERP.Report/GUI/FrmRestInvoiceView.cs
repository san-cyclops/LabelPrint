...
{
    public partial class FrmRestInvoiceView : FrmBaseReportsForm
    {
        public FrmRestInvoiceView(AutoGenerateInfo autoGenerateInfo) 
        {
            InitializeComponent();
        ...
        private void btnBrowse_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(cmbLocation.Text.Trim()) && !string.IsNullOrEmpty(cmbBillingLocation.Text.Trim()))
                {
                    FrmBrowseInvoice frmBrowseInvoice = new FrmBrowseInvoice(Common.ConvertStringToInt(cmbLocation.SelectedValue.ToString()), Common.ConvertStringToInt(cmbBillingLocation.SelectedValue.ToString()),dateFrom,dateTo);
                    frmBrowseInvoice.ShowDialog();
                    //ViewReport(dateFrom, dateTo, Common.ConvertStringToInt(cmbLocation.SelectedValue.ToString()), Common.ConvertStringToInt(cmbBillingLocation.SelectedValue.ToString()));
                }
                else
                {
