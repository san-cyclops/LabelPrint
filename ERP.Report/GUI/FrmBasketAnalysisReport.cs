    ...
    public partial class FrmBasketAnalysisReport : FrmBaseReportsForm
    {
        ...
        public override void View()
        {
            try
            {
                ...
                {
                    Toast.Show(this.Text,"Please enter a valid Value Range for get this report","", Toast.messageType.Warning, Toast.messageAction.General);
                    return;
                }
                ...
                if (!isLocationFound)
                {
                    Toast.Show(this.Text,"Please select valid Locations For get this report","", Toast.messageType.Warning, Toast.messageAction.General);
                    return;
                }
        ...
        {
            Common.HighlightControl(lblCustomerType);
        }

        private void cmbCustomerType_Leave(object sender, EventArgs e)
        {
            Common.UnHighlightControl(lblCustomerType);
        }

        private void chkExchange_Enter(object sender, EventArgs e)
        {
            Common.HighlightControl(chkExchange);
        }

        private void chkExchange_Leave(object sender, EventArgs e)
        {
            Common.UnHighlightControl(chkExchange);
        }

        private void chkGiftVoucher_Enter(object sender, EventArgs e)
        {
            Common.HighlightControl(chkGiftVoucher);
        }

        private void chkGiftVoucher_Leave(object sender, EventArgs e)
        {
            Common.UnHighlightControl(chkGiftVoucher);
        }

        private void chkGetLocationWise_Enter(object sender, EventArgs e)
        {
            Common.HighlightControl(chkGetLocationWise);
        }

        private void chkGetLocationWise_Leave(object sender, EventArgs e)
        {
            Common.UnHighlightControl(chkGetLocationWise);
        }

        private void chkDayReport_Enter(object sender, EventArgs e)
        {
            Common.HighlightControl(chkDayReport);
        }

        private void chkDayReport_Leave(object sender, EventArgs e)
        {
            Common.UnHighlightControl(chkDayReport);
        }

        private void chkMonday_Enter(object sender, EventArgs e)
        {
            Common.HighlightControl(chkMonday);
        }

        private void chkMonday_Leave(object sender, EventArgs e)
        {
            Common.UnHighlightControl(chkMonday);
        }

        private void chkTuesday_Enter(object sender, EventArgs e)
        {
            Common.HighlightControl(chkTuesday);
        }

        private void chkTuesday_Leave(object sender, EventArgs e)
        {
            Common.UnHighlightControl(chkTuesday);
        }

        private void chkWednesday_Enter(object sender, EventArgs e)
        {
            Common.HighlightControl(chkWednesday);
        }

        private void chkWednesday_Leave(object sender, EventArgs e)
        {
            Common.UnHighlightControl(chkWednesday);
        }

        private void chkThursday_Enter(object sender, EventArgs e)
        {
            Common.HighlightControl(chkThursday);
        }

        private void chkThursday_Leave(object sender, EventArgs e)
        {
            Common.UnHighlightControl(chkThursday);
        }

        private void chkFriday_Enter(object sender, EventArgs e)
        {
            Common.HighlightControl(chkFriday);
        }

        private void chkFriday_Leave(object sender, EventArgs e)
        {
            Common.UnHighlightControl(chkFriday);
        }

        private void chkSaturday_Enter(object sender, EventArgs e)
        {
            Common.HighlightControl(chkSaturday);
        }

        private void chkSaturday_Leave(object sender, EventArgs e)
        {
            Common.UnHighlightControl(chkSaturday);
        }

        private void chkSunday_Enter(object sender, EventArgs e)
        {
            Common.HighlightControl(chkSunday);
        }

        private void chkSunday_Leave(object sender, EventArgs e)
        {
            Common.UnHighlightControl(chkSunday);
        }

        private void rdoValue_Enter(object sender, EventArgs e)
        {
            Common.HighlightControl(rdoValue);
        }

        private void rdoValue_Leave(object sender, EventArgs e)
        {
            Common.UnHighlightControl(rdoValue);
        }

        private void rdoQty_Enter(object sender, EventArgs e)
        {
            Common.HighlightControl(rdoQty);
        }

        private void rdoQty_Leave(object sender, EventArgs e)
        {
            Common.UnHighlightControl(rdoQty);
        }

        private void rdoItem_Enter(object sender, EventArgs e)
        {
            Common.HighlightControl(rdoItem);
        }

        private void rdoItem_Leave(object sender, EventArgs e)
        {
            Common.UnHighlightControl(rdoItem);
        }
