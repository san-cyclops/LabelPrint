...
namespace ERP.Utility
{
    public static class Validater
    {
        ...
        public static bool ValidateTextBox(string formCaption, ErrorProvider errorProvider, ValidateType validateType, params TextBox[] textBox)
        {
            errorProvider.Clear();
            bool isValid = true;
            ...
            if (!isValid)
                Toast.Show(formCaption,"","", Toast.messageType.Error, Toast.messageAction.ValidationFailed);
            return isValid;
        }
        ...
        public static bool ValidateComboBox(string formCaption,ErrorProvider errorProvider, ValidateType validateType, params ComboBox[] comboBox)
        {
            errorProvider.Clear();
            bool isValid = true;
        ...
        public static bool ValidateDateTimePicker(string formCaption, ErrorProvider errorProvider, ValidateType validateType, params DateTimePicker[] dateTimePicker)
        {
            errorProvider.Clear();
            bool isValid = true;
        ...
        public static bool ValidateControls(string formCaption, ErrorProvider errorProvider, ValidateType validateType, params Control[] controlBox)
        {
            errorProvider.Clear();
            bool isValid = true;
        ...
        //    return isValid;
        //}
        public static bool ValidateTextBoxWithCustomerMessage(string formCaption, string message, ErrorProvider errorProvider, ValidateType validateType, params TextBox[] textBox)
        {
            errorProvider.Clear();
            bool isValid = true;
            ...
            if (!isValid)
            {
                Toast.Show(formCaption,message,"", Toast.messageType.Warning, Toast.messageAction.General);
            }
            return isValid;
        }

        public static bool ValidateCharacterLength(string formCaption, ErrorProvider errorProvider, ValidateType validateType, TextBox textBox, int textLength)
        {
            errorProvider.Clear();
            bool isValid = true;
            ...
            switch (validateType)
            {
                case ValidateType.Length:
                {
                    ...
                    {
                        //errorProvider.SetError(textBox, textBox.TextLength + " Invalid Length.\nLength must be - " + textLength);
                ...
                break;
                case ValidateType.LengthLessThan:
                {
                    if (!string.IsNullOrEmpty(textBox.Text.Trim()) && textBox.TextLength > textLength)
                    {
                        //errorProvider.SetError(textBox, textBox.TextLength + " Invalid Length.\nLength must be - " + textLength);
                        errorProvider.SetError(textBox, " Invalid Length.\nLength must be Lesser than - " + textLength);
                        errorProvider.SetIconAlignment(textBox, ErrorIconAlignment.MiddleLeft);
                        isValid = false;
                    }
                }
        ...
        public static bool ValidateDate(string formCaption, ErrorProvider errorProvider, ValidateType validateType, DateTimePicker compareDate, DateTime fromDate, DateTime toDate)
        {
            errorProvider.Clear();
            bool isValid = true;
        ...
        public static bool ValidateTextboxForNumbers(object sender, KeyPressEventArgs e) 
        {
