...
namespace ERP.UI.Windows.CustomControls
{
    ...
    /// </summary>
    /// 
    public partial class TextBoxCurrencyMinusAllowed : TextBox
    {
        ...
        // constructor
        public TextBoxCurrencyMinusAllowed()
        {
            InitializeComponent();
            CurrencyValue = 0;
        }
        ...
        /// <param name="e"></param>
        private void TextBoxCurrencyMinusAllowed_KeyPress(object sender, KeyPressEventArgs e)
        {
            SetMaxLength();
            ...
            if (e.KeyChar == '.' && this.Text.Contains(".") && this.Text.Contains('-') && this.Text.Contains("-"))
            {
                e.Handled = true;
            }
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void TextBoxCurrencyMinusAllowed_Validated(object sender, EventArgs e)
        {
            try
            {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void TextBoxCurrencyMinusAllowed_Click(object sender, EventArgs e)
        {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void TextBoxCurrencyMinusAllowed_TextChanged(object sender, EventArgs e)
        {
            try
            {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void TextBoxCurrencyMinusAllowed_Enter(object sender, EventArgs e)
        {
            try
            {
                this.Text = mCurrencyValue.ToString();
